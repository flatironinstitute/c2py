...
template <> const std::map<E1, std::string> c2py::enum_to_string<E1>       = {{E1::a, "a"}, {E1::b, "b"}, {E1::c, "c"}};
template <> constexpr bool c2py::is_wrapped<E2>                            = true;
template <> const std::map<E2, std::string> c2py::enum_to_string<E2>       = {{E2::A, "A"}, {E2::B, "B"}, {E2::C, "C"}};
template <> constexpr bool c2py::is_wrapped<D::E3>                         = true;
template <> const std::map<D::E3, std::string> c2py::enum_to_string<D::E3> = {{D::E3::d, "d"}, {D::E3::e, "e"}, {D::E3::f, "f"}};
