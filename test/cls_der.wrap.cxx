...
// b
static auto const fun_0 = c2py::dispatcher_f_kw_t{c2py::cmethod([](B &self, int u) -> decltype(auto) { return self.b(u); }, "self", "u")};
...
static auto const fun_1 =
   c2py::dispatcher_f_kw_t{c2py::cmethod([](A &self, int i, int j) -> decltype(auto) { return self.a(i, j); }, "self", "i", "j")};
