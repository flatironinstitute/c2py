...
// inc_opaque
static auto const fun_0 = c2py::dispatcher_f_kw_t{c2py::cfun([](opaque &x) { return inc_opaque(x); }, "x")};

// make_opaque
static auto const fun_1 = c2py::dispatcher_f_kw_t{c2py::cfun([]() { return make_opaque(); })};

// take_opaque
static auto const fun_2 = c2py::dispatcher_f_kw_t{c2py::cfun([](const opaque &x) { return take_opaque(x); }, "x")};
