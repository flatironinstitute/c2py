...
template <>
const std::string c2py::tp_ctor_doc<A> = c2py::replace_tags(R"DOC(Synthesized constructor with the following keyword arguments:
...
template <>
constinit PyGetSetDef c2py::tp_getset<A>[] = {c2py::getsetdef_from_member<&A::x_, A>("x_", doc_member_0),
                                              c2py::getsetdef_from_member<&A::y_, A>("y_", doc_member_1),
                                              {"x", c2py::getter_from_method<c2py::castmc<>(&A::get_x)>, nullptr, prop_doc_0, nullptr},
                                              {"y", c2py::getter_from_method<c2py::castmc<>(&A::get_y)>, (setter)c2py::setter_from_method<&A::set_y>,
                                               prop_doc_1, (void *)"Cannot delete the attribute y"},
...
template <> constexpr initproc c2py::tp_init<B> = synth_constructor_1;
...
constinit PyGetSetDef c2py::tp_getset<B>[] = {
   c2py::getsetdef_from_member<&B::val_, B>("val_", doc_member_2),
...
static int synth_constructor_2(PyObject *self, PyObject *args, PyObject *kwargs) {
  ...
  c2py::pydict_extractor de{kwargs};
  try {
    ((c2py::wrap<C> *)self)->_c = new C{};
  } catch (std::exception const &e) {
    PyErr_SetString(PyExc_RuntimeError, ("Error in constructing C from a Python dict.\n   "s + e.what()).c_str());
    return -1;
  }
  auto &self_c = *(((c2py::wrap<C> *)self)->_c);
  de("v_", self_c.v_, true);
  return de.check();
}

template <> constexpr initproc c2py::tp_init<C> = synth_constructor_2;

template <>
const std::string c2py::tp_ctor_doc<C> = c2py::replace_tags(R"DOC(Synthesized constructor with the following keyword arguments:
...
v_ : {par_0}, default=42
                                                            ...
                                                            "par", {c2py::python_typename<int>()});
// add
static auto const fun_0 = c2py::dispatcher_f_kw_t{c2py::cmethod([](C const &self, int n) -> decltype(auto) { return self.add(n); }, "self", "n")};
...
template <>
constinit PyGetSetDef c2py::tp_getset<C>[] = {c2py::getsetdef_from_member<&C::v_, C>("v_", doc_member_3),
...
template <> const std::string c2py::tp_doc<C> = R"DOC()DOC" + c2py::tp_ctor_doc<C>;
