...
// A quick hack to get the type_name from the compilers.
// from https://bitwizeshift.github.io/posts/2021/03/09/getting-an-unmangled-type-name-at-compile-time/#function-name
namespace c2py::util {
